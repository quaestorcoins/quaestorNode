...
/* *** BEGIN DARKSEND MAGIC - QUAESTOR **********
    Copyright (c) 2014-2015, Quaestor Developers
        eduffield - evan@quaestorpay.io
        udjinm6   - udjinm6@quaestorpay.io
*/
    ...
    if(fMasterNode) {
        ...
        BOOST_FOREACH(const CTransaction& txCollateral, vecSessionCollateral) {
            ...
            /*
                ...
                allow endless transaction that would bloat Quaestor and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("quaestor-darksend");
