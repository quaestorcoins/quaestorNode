...
/**
 * Quaestor RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern json_spirit::Value listunspentaccount(const json_spirit::Array& params, bool fHelp);
...
extern json_spirit::Value getblockbyno(const json_spirit::Array& params, bool fHelp);
