...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("QUAESTOR Core QUAESTOR-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  QUAESTOR-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded QUAESTOR transaction") + "\n" +
              "  QUAESTOR-tx [options] -create [commands]   " + _("Create hex-encoded QUAESTOR transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded QUAESTOR transaction
