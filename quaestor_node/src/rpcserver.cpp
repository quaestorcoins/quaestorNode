...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Quaestor server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Quaestor server stopping";
}
...
{ //  category              name                      actor (function)         okSafeMode threadSafe reqWallet
  //  --------------------- ------------------------  -----------------------  ---------- ---------- ---------
	...
	{ "blockchain",         "getblockbyno",           &getblockbyno,           true,      false,      false },
    ...
    /* Quaestor features */
    { "quaestor",               "masternode",             &masternode,             true,      true,       false },
    { "quaestor",               "masternodelist",         &masternodelist,         true,      true,       false },
    { "quaestor",               "masternodebroadcast",    &masternodebroadcast,    true,      true,       false },
    { "quaestor",               "mnbudget",               &mnbudget,               true,      true,       false },
    { "quaestor",               "mnbudgetvoteraw",        &mnbudgetvoteraw,        true,      true,       false },
    { "quaestor",               "mnfinalbudget",          &mnfinalbudget,          true,      true,       false },
    { "quaestor",               "mnsync",                 &mnsync,                 true,      true,       false },
    { "quaestor",               "spork",                  &spork,                  true,      true,       false },
#ifdef ENABLE_WALLET
    { "quaestor",               "darksend",               &darksend,               false,     false,      true  }, /* not threadSafe because of SendMoney */
	...
	{ "wallet",             "listunspentaccount",     &listunspentaccount,     false,     false,      true },
    { "wallet",             "lockunspent",            &lockunspent,            true,      false,      true },
    { "wallet",             "move",                   &movecmd,                false,     false,      true },
    { "wallet",             "sendfrom",               &sendfrom,               false,     false,      true },
    { "wallet",             "sendmany",               &sendmany,               false,     false,      true },
    { "wallet",             "sendtoaddress",          &sendtoaddress,          false,     false,      true },
	{ "wallet",             "sendtransaction",        &sendtransaction,    	   false,     false,      true },
...
void StartRPCThreads()
{
         ...
         (mapArgs["-rpcuser"] == mapArgs["-rpcpassword"])) && Params().RequireRPCPassword())
    {
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
            _("To use quaestord, or the -server option to quaestor-qt, you must set an rpcpassword in the configuration file:\n"
              "%s\n"
...
std::string HelpExampleCli(string methodname, string args){
    return "> quaestor-cli " + methodname + " " + args + "\n";
}
