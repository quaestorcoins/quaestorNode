    ...
    spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Quaestor Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle *networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Quaestor address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and quaestor: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Quaestor Core"), this);
    aboutAction->setStatusTip(tr("Show information about Quaestor Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Quaestor"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Quaestor addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Quaestor addresses"));
    ...
    openAction->setStatusTip(tr("Open a quaestor: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Quaestor Core help message to get a list with possible Quaestor command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Quaestor Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Quaestor network", "", count));
}
...
{
    QString strTitle = tr("Quaestor Core"); // default title
