...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Quaestor Core"),
     ...
     * override -datadir in the quaestor.conf file in the default data directory
     * (to be consistent with quaestord behavior)
     */
    if(dataDir != getDefaultDataDirectory())
