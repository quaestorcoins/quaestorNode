    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Quaestor Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (about)
    {
        setWindowTitle(tr("About Quaestor Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  quaestor-qt [" + tr("command-line options") + "]                     " + "\n";
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Quaestor Core is shutting down...") + "<br /><br />" +
