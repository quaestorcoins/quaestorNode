...
RESOURCES += src/qt/quaestor.qrc src/qt/quaestor_locale.qrc
TRANSLATIONS += src/qt/locale/quaestor_bg.ts \
                src/qt/locale/quaestor_de.ts \
                src/qt/locale/quaestor_en.ts \
                src/qt/locale/quaestor_es.ts \
                src/qt/locale/quaestor_fi.ts \
                src/qt/locale/quaestor_fr.ts \
                src/qt/locale/quaestor_it.ts \
                src/qt/locale/quaestor_ja.ts \
                src/qt/locale/quaestor_pl.ts \
                src/qt/locale/quaestor_pt.ts \
                src/qt/locale/quaestor_ru.ts \
                src/qt/locale/quaestor_sk.ts \
                src/qt/locale/quaestor_sv.ts \
                src/qt/locale/quaestor_vi.ts \
                src/qt/locale/quaestor_zh_CN.ts \
                src/qt/locale/quaestor_zh_TW.ts
