...
Only requiring some minor changes is quaestor.cpp.
...
Changes to quaestor.cpp
----------------------
quaestor.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
